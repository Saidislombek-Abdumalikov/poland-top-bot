export const uz = {
  ...
  uni_list_title: "🎓 <b>Polshaning Yetakchi Universitetlari</b>\nFakultetlar, reyting va qabul talablari bilan tanishish uchun universitetni tanlang:",
  uni_filter_all: "Barcha shaharlar",
  uni_filter_public: "🏛️ Davlat Universitetlari",
  uni_filter_private: "🏢 Xususiy Universitetlar",
  uni_filter_city: "🏙️ Shahar bo'yicha",
  ...
  uni_btn_view_programs: "📚 {abbr} dasturlarini ko'rish",
  uni_btn_apply: "📝 Universitetga ariza topshirish",

  // Programs Section
  prog_list_title: "📚 <b>Polshadagi Ta'lim Dasturlari</b>",
  prog_filter_level: "🎓 Ta'lim Darajasi",
  prog_filter_field: "🔬 Yo'nalish Sohasi",
  prog_filter_city: "🏙️ Shahar",
  prog_filter_clear: "🔄 Filtrlarni tozalash",
